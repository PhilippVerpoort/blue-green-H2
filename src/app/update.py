...
def updateScenarioInputSimple(scenarioInput: dict,
    ...
    # update blue data
    scenarioInput['params']['cost_blue_capex']['value']['heb'] = simple_cost_blue_capex_heb
    scenarioInput['params']['cost_blue_capex']['value']['leb'] = simple_cost_blue_capex_leb
    ...
    scenarioInput['params']['cost_blue_eff']['value']['heb'] = simple_cost_blue_eff_heb
    scenarioInput['params']['cost_blue_eff']['value']['leb'] = simple_cost_blue_eff_leb
