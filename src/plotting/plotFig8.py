...
def plotFig8(fuelSpecs: dict, fuelData: pd.DataFrame, config: dict, scenario_name = "", export_img: bool = True):
    # filter data
    ...
    if export_img:
        fig.write_image("output/fig8" + ("_"+scenario_name if scenario_name else "") + ".png")
